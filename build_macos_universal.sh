...
# Universal Binary Build Script for FonixFlow (macOS)
# Builds for both Apple Silicon (ARM64) and Intel (x86_64)
# Usage: ./build_macos_universal.sh

# Exit on error
set -e

APP_NAME="FonixFlow"
SPEC_FILE="fonixflow_qt.spec"

echo "=========================================="
echo "📦 Building FonixFlow Universal Binary (macOS)"
echo "=========================================="
