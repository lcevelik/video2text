...
# Use encoded file for distribution (generated by tools/prepare_build.sh)
# Falls back to plaintext for development builds
if os.path.exists('licenses.dat'):
    license_file = 'licenses.dat'
    print("✓ Using encoded license file: licenses.dat")
else:
    license_file = 'licenses.txt'
    print("⚠️  Using plaintext license file: licenses.txt")
    print("   Run tools/prepare_build.sh to encode licenses for distribution")
